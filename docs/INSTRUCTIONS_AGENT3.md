# Agent 3 Instructions — Camp Lakota WordPress Image Metadata

## Your Assignment (Agent 3)

You are responsible for processing **List 3** of unprocessed WordPress Media images and updating each image with accurate, SEO-friendly metadata.

### Files (your input list)
- **Primary list (CSV):** `/Users/jasonmellet/Desktop/AGT_Camp_Lakota/work/image-metadata/inputs/image_remaining_unprocessed_part3.csv`
- **Backup list (JSON):** `/Users/jasonmellet/Desktop/AGT_Camp_Lakota/work/image-metadata/inputs/image_remaining_unprocessed_part3.json`

### List 3 range (for sanity check)
- **48 images**
- **First ID:** `1848`
- **Last ID:** `1456`
...
- Examples:
  - “Camp Lakota Campers Playing Soccer on Open Field”
  - “Camp Lakota Waterfront Swimming at Masten Lake”
...
- `/Users/jasonmellet/Desktop/AGT_Camp_Lakota/work/agents/agent3_done_ids.txt`
...
- `/Users/jasonmellet/Desktop/AGT_Camp_Lakota/work/agents/agent3_questions.txt`
...
- Alt text should describe the graphic (e.g., “Camp Lakota logo”).
- Don’t force “Masten Lake” or “sleepaway camp” if the image is purely a logo/icon.
...
### Duplicate images
- If two images appear identical, still give accurate metadata, but note in `agent3_questions.txt` so Jason can decide whether to delete duplicates later.
...
- The completed `agent3_done_ids.txt`
- Any `agent3_questions.txt`
